...
class PromotionEndingSoonPromotionsController extends AbstractController
{
    ...
    /**
     * @Route(
     *     "/api/promo/promotions/list/endingSoon",
     *      name="promo_promotions_ending_soon",
     *      methods={"GET"},
     * )
     */
    public function get(): Response
    {
        $promotions = $this->repository->getPromotionsEndingSoon();
        if ($promotions) {
